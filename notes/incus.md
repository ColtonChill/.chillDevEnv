...
### Set up shared disk
incus config device add bld-sigma-rocky sigma disk path=/root/sigma source='/home/chill/work/sigma'
incus config set bld-sigma-rocky security.privileged true
incus config set bld-sigma-rocky security.nesting true

### For Nesting containers
incus config set bld-sigma-rocky security.nesting true
incus config set bld-sigma-rocky raw.lxc "
