...
alias cmake_deb_cuda='cmake -D DEBIAN_BUILD=true -D CMAKE_BUILD_TYPE=Release -D CMAKE_EXPORT_COMPILE_COMMANDS=ON -D BUILD_WITH_CUDA=ON ../'

alias cmake_rocky_re='cmake -D ROCKY_BUILD=true -D CMAKE_BUILD_TYPE=Release -D CMAKE_EXPORT_COMPILE_COMMANDS=ON ../'
