...
alias cmake_deb_cuda_util='cmake -D DEBIAN_BUILD=true -D CMAKE_BUILD_TYPE=Release -D CMAKE_EXPORT_COMPILE_COMMANDS=ON -D SIGMA_BUILD_WITH_CUDA=ON -D TENSORRT_BUILD_TEST_UTIL=ON ../'
...
alias cmake_rocky_cuda='cmake -D ROCKY_BUILD=true -D CMAKE_BUILD_TYPE=Release -D SIGMA_BUILD_WITH_CUDA=ON -D TENSORRT_BUILD_TEST_UTIL=ON ../'
