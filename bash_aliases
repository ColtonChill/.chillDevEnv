...
# Sigma Building
alias cmake_deb_de='cmake -D DEBIAN_BUILD=true -D CMAKE_BUILD_TYPE=Debug -D SIGMA_BUILD_DOC=OFF -D CMAKE_EXPORT_COMPILE_COMMANDS=ON ../'
alias cmake_deb_re='cmake -D DEBIAN_BUILD=true -D CMAKE_BUILD_TYPE=Release -D SIGMA_BUILD_DOC=OFF -D CMAKE_EXPORT_COMPILE_COMMANDS=ON ../'
alias cmake_deb_cuda='cmake -D DEBIAN_BUILD=true -D CMAKE_BUILD_TYPE=Release -D SIGMA_BUILD_DOC=OFF -D CMAKE_EXPORT_COMPILE_COMMANDS=ON -D SIGMA_BUILD_WITH_CUDA=ON ../'

alias cmake_rocky_re='cmake -D ROCKY_BUILD=true -D CMAKE_BUILD_TYPE=Release -D CMAKE_EXPORT_COMPILE_COMMANDS=ON -D SIGMA_BUILD_DOC=OFF ../'
alias cmake_rocky_cuda='cmake -D ROCKY_BUILD=true -D CMAKE_BUILD_TYPE=Release -D CMAKE_EXPORT_COMPILE_COMMANDS=ON -D SIGMA_BUILD_DOC=OFF -D SIGMA_BUILD_WITH_CUDA=ON ../'
...
alias cmake_jet5_de='cmake -D CMAKE_TOOLCHAIN_FILE=../toolchains/jetpack5.cmake -D CMAKE_BUILD_TYPE=Debug -D SIGMA_BUILD_DOC=OFF -D CMAKE_EXPORT_COMPILE_COMMANDS=ON ../'
alias cmake_jet5_re='cmake -D CMAKE_TOOLCHAIN_FILE=../toolchains/jetpack5.cmake -D CMAKE_BUILD_TYPE=Release -D SIGMA_BUILD_DOC=OFF -D CMAKE_EXPORT_COMPILE_COMMANDS=ON ../'
alias cmake_jet6_de='cmake -D CMAKE_TOOLCHAIN_FILE=../toolchains/jetpack6.cmake -D CMAKE_BUILD_TYPE=Debug -D SIGMA_BUILD_DOC=OFF -D CMAKE_EXPORT_COMPILE_COMMANDS=ON ../'
alias cmake_jet6_re='cmake -D CMAKE_TOOLCHAIN_FILE=../toolchains/jetpack6.cmake -D CMAKE_BUILD_TYPE=Release -D SIGMA_BUILD_DOC=OFF -D CMAKE_EXPORT_COMPILE_COMMANDS=ON ../'
